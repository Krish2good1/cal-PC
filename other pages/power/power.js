...
function calculateResult() {
    ...
    // Convert input to base unit (Watts)
    const baseValue = inputValue * (powerConversionToWatts[fromUnit] || 1);

    // Convert base value to target unit
    const result = baseValue / (powerConversionToWatts[toUnit] || 1);
